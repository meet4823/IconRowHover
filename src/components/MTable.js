...
function MTable() {
  ...
  const [rightObj,changeRight] = React.useState({right:0})
  ...
  const fun = () =>{
    ...
    var val = cont.scrollLeft;
    val = 0 - parseInt(val) ;

    changeRight({right: val })
  ...
  return (
    <TableContainer onScroll={fun} component={Paper} className="table-container"  id="table-container">
          ...
          {USERS.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => (
            <TableRow key={row.name} className='roww'>
              ...
              <TableCell>
                ...
                <TableCell className='hide' style={rightObj} id="patel">X
</TableCell>
            </TableRow>
          ))}
        </TableBody>
